...
export const pluginSelect =
  "id,name,slug,logo_url,short_description,price,currency,pricing_model,is_open_source,rating_average,reviews_count,downloads_count,updated_at,platform:platforms(name,slug),developer:developer_profiles(name,slug),plugin_assets(asset_type,public_url)" as const;
