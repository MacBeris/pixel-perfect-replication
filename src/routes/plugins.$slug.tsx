...
export const Route = createFileRoute("/plugins/$slug")({
  head: ({ params }) => ({
    meta: [
      ...
      { name: "description", content: `Details, pricing, versions and reviews for ${params.slug} on Extendly.` },
      { property: "og:title", content: `${params.slug} — plugin on Extendly` },
      { property: "og:description", content: `Details, pricing, versions and reviews for ${params.slug}.` },
