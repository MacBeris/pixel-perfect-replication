...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ExtendShare — Plugin & extension marketplace" },
      {
        name: "description",
        content:
    ...
    links: [
      ...
      { rel: "icon", href: "/extendshare-icon-2026.ico", sizes: "any" },
      {
        rel: "icon",
        href: "/extendshare-icon-2026-32.png",
        type: "image/png",
        sizes: "32x32",
      },
      {
        rel: "icon",
        href: "/extendshare-icon-2026-48.png",
        type: "image/png",
        sizes: "48x48",
      },
      {
        rel: "apple-touch-icon",
        href: "/extendshare-apple-touch-2026.png",
        sizes: "180x180",
      },
