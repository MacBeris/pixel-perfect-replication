  ...
  public: {
    Tables: {
      ...
      developer_profile_evidence: {
        ...
        Relationships: [
          {
            foreignKeyName: "developer_profile_evidence_developer_id_fkey";
            columns: ["developer_id"];
            isOneToOne: true;
            referencedRelation: "developer_profiles";
            referencedColumns: ["id"];
      ...
      site_analytics_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "site_analytics_events_plugin_id_fkey";
            columns: ["plugin_id"];
            isOneToOne: false;
            referencedRelation: "plugins";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      admin_restore_removed_plugin: {
        Args: { _actor_id: string; _plugin_id: string };
        Returns: Json;
      };
      admin_review_plugin_change_request: {
        Args: {
          _actor_id: string;
          _approve: boolean;
          _notes?: string;
      ...
      admin_site_analytics: {
        Args: { _actor_id: string; _range?: string };
        Returns: Json;
      };
      ...
      publishing_action_legacy: {
        Args: { _action: string; _actor: string; _input: Json };
        Returns: Json;
      };
      publishing_action_lifecycle: {
        Args: { _action: string; _actor: string; _input: Json };
        Returns: Json;
      };
    ...
    Enums: {
      analytics_event_type:
        "page_view" | "outbound_click" | "download" | "purchase" | "favorite" | "wishlist_add";
      ...
      purchase_status: "pending" | "paid" | "refunded" | "partially_refunded" | "failed";
      ...
      transaction_type: "sale" | "platform_fee" | "refund" | "payout" | "adjustment";
