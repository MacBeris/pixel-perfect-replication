...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      owns_developer: { Args: { _developer_id: string }; Returns: boolean }
      owns_plugin: { Args: { _plugin_id: string }; Returns: boolean }
      plugin_is_public: { Args: { _plugin_id: string }; Returns: boolean }
    }
    Enums: {
